    ...
    <div>
      ...
      >
        ...
        <p className="text-sm text-gray-600">
          <span className="font-medium text-blue-600">Fiş görseli seç</span> ya da buraya sürükle
        </p>
        <p className="text-xs text-gray-400">Aynı anda birden fazla fotoğraf seçebilirsin</p>
      </div>
